...
const COPY = {
  uk: {
    ...
    h1: 'Контакти',
    sub: 'Liczyly Dealing Representative у Калгарі. Працюю з клієнтами в Альберті, Британській Колумбії та Онтаріо. Дзвінки веду українською, російською або англійською.',
