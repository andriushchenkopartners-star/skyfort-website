...
export const dictionary = {
  uk: {
    ...
    faq: [
      ...
      { q: "Що таке Eligible Investor?", a: "CSA NI 45-106 категорія. Спрощено: $75K+ income solo / $125K+ household, або $400K net assets без primary residence. Це не «тест IQ» — це регуляторні кваліфікації. Для нижчих категорій є альтернативи через TFSA/RRSP/FHSA." },
  ...
  ru: {
    ...
    faq: [
      ...
      { q: "Что такое Eligible Investor?", a: "CSA NI 45-106 категория. Упрощённо: $75K+ income solo / $125K+ household, или $400K net assets без primary residence. Это не «тест IQ» — это регуляторные квалификации. Для более низких категорий есть альтернативы через TFSA/RRSP/FHSA." },
  ...
  en: {
    ...
    faq: [
      ...
      { q: "What's an Eligible Investor?", a: "CSA NI 45-106 category. Simplified: $75K+ solo income / $125K+ household, or $400K net assets excluding primary residence. It's not an IQ test — it's a regulatory qualification. For lower thresholds there are alternatives via TFSA/RRSP/FHSA." },
