...
const LINKS = {
  tfsaCalc: "/tfsa-growth",        // роут TFSA-калькулятора
  freedomCalc: "/financial-freedom", // роут калькулятора фін. свободи
  mortgageCalc: "/mortgage",       // роут mortgage-калькулятора
...
export default function Page() {
  return (
    <main className="sf-links">
      ...
      <a className="sf-link" href={LINKS.guides} data-ph-capture-attribute-bio-link="guides">
        📚 Безкоштовні гайди (TFSA, FHSA, пенсія…)
      </a>
