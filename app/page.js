...
const t = {
  uk: {
    ...
    guides: [
      {
        icon: PiggyBank,
        title: "TFSA + Exempt Market",
        desc: "Як TFSA працює насправді. 5 помилок які знищать рахунок. Що таке exempt market і кому туди можна.",
        file: "01_SkyFort_TFSA_Exempt_Market.pdf",
      },
      {
        icon: ShieldCheck,
        title: "Pension Deficit",
        desc: "CPP + OAS = $1,800/міс. Витрати на пенсії $4,500. Як закрити різницю.",
        file: "02_SkyFort_Pension_Deficit.pdf",
      },
      {
        icon: TrendingUp,
        title: "GIC Alternatives",
        desc: "GIC дає 4%, інфляція з'їдає 3%. 4 альтернативи які працюють краще.",
        file: "03_SkyFort_GIC_Alternatives.pdf",
      },
      {
        icon: CalendarCheck,
        title: "90 Day Freedom",
        desc: "Покроковий план виходу з фінансової пастки $120K зарплати в Калгарі.",
        file: "04_SkyFort_90_Day_Freedom.pdf",
      },
      {
        icon: Home,
        title: "FHSA · перша квартира",
        desc: "$8K/рік tax-deductible, $40K lifetime. Як використати правильно.",
        file: "05_SkyFort_FHSA_First_Home.pdf",
      },
      {
        icon: GraduationCap,
        title: "RESP · освіта дитини",
        desc: "Уряд додає $7,200 безкоштовно. Три стратегії — від $208 до $50K одразу.",
        file: "06_SkyFort_RESP_Education.pdf",
      },
      {
        icon: Compass,
        title: "Newcomer · 30 кроків",
        desc: "Що зробити в перші 90 днів у Канаді. Від SIN до першого TFSA.",
        file: "07_SkyFort_Newcomer_30_Steps.pdf",
      },
    ],
    ...
    faq: [
      {
        q: "Це безкоштовно? У чому каверза?",
        a: "Discovery call безкоштовний. Якщо рекомендую exempt market продукт і ти на нього підписуєшся — я отримую commission від issuer (це стандарт у Канаді, прозоро прописано в Offering Memorandum). Якщо ні — нічого не плачу, нічого не винний.",
      },
      {
        q: "Чим ти відрізняєшся від банку?",
        a: "Банк може продати тільки те що у банку. Я як Dealing Representative маю доступ до exempt market — це private MICs, REITs, private lending з historical returns 7-12% — те що не продається через RBC чи TD.",
      },
      {
        q: "Що таке Eligible Investor?",
        a: "CSA NI 45-106 категорія. Спрощено: $75K+ income solo / $125K+ household, або $400K net assets ex-primary residence. На discovery call я перевіряю суюту через офіційну анкету.",
      },
      {
        q: "Я newcomer, в мене ще немає $400K. Чи є сенс говорити?",
        a: "Так. 80% моїх клієнтів починають з TFSA/RRSP setup і освіти. Exempt market — це коли вже є infrastructure. Дзвінок все одно корисний — побудуєш roadmap на 2-3 роки.",
      },
    ],
    ...
    footer: {
      ...
      disclaimer:
        "Andrii Andriushchenko — Dealing Representative registered with Axcess Capital Advisors Inc. (EMD). Personally registered: Alberta, British Columbia, Ontario. Content on this site is educational and is not investment advice or a solicitation to buy/sell securities. Exempt market investments are restricted to Eligible Investors as defined under National Instrument 45-106. Past performance does not guarantee future results.",
    ...
    guides: [
      {
        icon: PiggyBank,
        title: "TFSA + Exempt Market",
        desc: "Как TFSA работает на самом деле. 5 ошибок которые уничтожат счёт. Что такое exempt market и кому туда можно.",
        file: "01_SkyFort_TFSA_Exempt_Market.pdf",
      },
      {
        icon: ShieldCheck,
        title: "Pension Deficit",
        desc: "CPP + OAS = $1,800/мес. Расходы на пенсии $4,500. Как закрыть разницу.",
        file: "02_SkyFort_Pension_Deficit.pdf",
      },
      {
        icon: TrendingUp,
        title: "GIC Alternatives",
        desc: "GIC даёт 4%, инфляция съедает 3%. 4 альтернативы которые работают лучше.",
        file: "03_SkyFort_GIC_Alternatives.pdf",
      },
      {
        icon: CalendarCheck,
        title: "90 Day Freedom",
        desc: "Пошаговый план выхода из финансовой ловушки $120K зарплаты в Калгари.",
        file: "04_SkyFort_90_Day_Freedom.pdf",
      },
      {
        icon: Home,
        title: "FHSA · первая квартира",
        desc: "$8K/год tax-deductible, $40K lifetime. Как использовать правильно.",
        file: "05_SkyFort_FHSA_First_Home.pdf",
      },
      {
        icon: GraduationCap,
        title: "RESP · образование ребёнка",
        desc: "Правительство добавляет $7,200 бесплатно. Три стратегии — от $208 до $50K сразу.",
        file: "06_SkyFort_RESP_Education.pdf",
      },
      {
        icon: Compass,
        title: "Newcomer · 30 шагов",
        desc: "Что сделать в первые 90 дней в Канаде. От SIN до первого TFSA.",
        file: "07_SkyFort_Newcomer_30_Steps.pdf",
      },
    ],
    ...
    faq: [
      {
        ...
        a: "Discovery call бесплатный. Если рекомендую exempt market продукт и ты на него подписываешься — я получаю commission от issuer (это стандарт в Канаде, прозрачно прописано в Offering Memorandum). Если нет — ничего не платишь, ничего не должен.",
      },
      {
        q: "Чем ты отличаешься от банка?",
        a: "Банк может продать только то что в банке. Я как Dealing Representative имею доступ к exempt market — это private MICs, REITs, private lending с historical returns 7-12% — то что не продаётся через RBC или TD.",
      },
      {
        q: "Что такое Eligible Investor?",
        a: "CSA NI 45-106 категория. Упрощённо: $75K+ income solo / $125K+ household, или $400K net assets ex-primary residence. На discovery call я проверяю статус через официальную анкету.",
      },
      {
        q: "Я newcomer, у меня ещё нет $400K. Есть ли смысл говорить?",
        a: "Да. 80% моих клиентов начинают с TFSA/RRSP setup и образования. Exempt market — это когда уже есть infrastructure. Звонок всё равно полезен — построишь roadmap на 2-3 года.",
      },
    ],
    ...
    guides: [
      {
        icon: PiggyBank,
        title: "TFSA + Exempt Market",
        desc: "How TFSA actually works. 5 mistakes that wreck the account. What exempt market is and who can access it.",
        file: "01_SkyFort_TFSA_Exempt_Market.pdf",
      },
      {
        icon: ShieldCheck,
        title: "Pension Deficit",
        desc: "CPP + OAS = $1,800/mo. Retirement expenses $4,500. How to close the gap.",
        file: "02_SkyFort_Pension_Deficit.pdf",
      },
      {
        icon: TrendingUp,
        title: "GIC Alternatives",
        desc: "GICs pay 4%, inflation eats 3%. 4 alternatives that work better.",
        file: "03_SkyFort_GIC_Alternatives.pdf",
      },
      {
        icon: CalendarCheck,
        title: "90 Day Freedom",
        desc: "Step-by-step exit from the $120K-salary trap in Calgary.",
        file: "04_SkyFort_90_Day_Freedom.pdf",
      },
      {
        icon: Home,
        title: "FHSA · first home",
        desc: "$8K/yr tax-deductible, $40K lifetime. How to use it right.",
        file: "05_SkyFort_FHSA_First_Home.pdf",
      },
      {
        icon: GraduationCap,
        title: "RESP · child's education",
        desc: "Government adds $7,200 for free. Three strategies — from $208/mo to $50K lump sum.",
        file: "06_SkyFort_RESP_Education.pdf",
      },
      {
        icon: Compass,
        title: "Newcomer · 30 steps",
        desc: "What to do in your first 90 days in Canada. From SIN to your first TFSA.",
        file: "07_SkyFort_Newcomer_30_Steps.pdf",
      },
    ],
    ...
    faq: [
      {
        ...
        a: "The discovery call is free. If I recommend an exempt market product and you subscribe to it, I receive commission from the issuer (this is standard in Canada and transparently disclosed in the Offering Memorandum). If not — you pay nothing, you owe nothing.",
      },
      {
        q: "How are you different from a bank?",
        a: "A bank can only sell what's inside the bank. As a Dealing Representative I have access to the exempt market — private MICs, REITs, private lending with historical returns of 7-12% — products you can't get through RBC or TD.",
      },
      {
        q: "What's an Eligible Investor?",
        a: "A CSA NI 45-106 category. Simplified: $75K+ solo income / $125K+ household, or $400K net assets excluding primary residence. I verify status on the discovery call via the official questionnaire.",
      },
      {
        q: "I'm a newcomer and don't have $400K yet. Is there still a point in talking?",
        a: "Yes. 80% of my clients start with TFSA/RRSP setup and education. Exempt market comes when the infrastructure is built. The call is still useful — you walk away with a 2–3 year roadmap.",
      },
    ],
...
// ─────────────────────────────────────────────────────────────────────────────
// CONFIG — placeholders Andrii replaces later
// ─────────────────────────────────────────────────────────────────────────────
...
const CONFIG = {
  ...
  // PDF base URL — replace with your Supabase public URL when ready
  pdfBaseUrl: "/guides",
};
...
function LangSwitcher({ lang, setLang }) {
  ...
  return (
    <div className="flex items-center gap-0 rounded-full border border-white/10 bg-white/5 p-1 backdrop-blur-sm">
...
function Nav({ lang, setLang, content }) {
  return (
    <nav className="fixed left-0 right-0 top-0 z-50 border-b border-white/5 bg-zinc-950/70 backdrop-blur-xl">
  ...
  return (
    <section id="top" className="relative overflow-hidden pt-40 pb-32 md:pt-48 md:pb-40">
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <h1 className="font-serif text-5xl leading-[1.05] tracking-tight text-white md:text-7xl lg:text-[88px]">
          {content.hero.title}
          <br />
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          <a
            ...
            target="_blank"
            rel="noopener"
            className="group inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-medium text-zinc-900 transition-all hover:bg-zinc-200"
          >
          ...
          <a
            href="#guides"
            className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 px-6 py-3.5 text-sm font-medium text-white transition-all hover:bg-white/5"
          >
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-6 py-16 md:grid-cols-4">
        {content.stats.map((s, i) => (
          <div key={i} className="border-l border-white/10 pl-5">
            ...
            <div className="mt-2 text-xs leading-relaxed text-zinc-500 md:text-sm">
              {s.label}
            </div>
          </div>
        ))}
...
function Guides({ content }) {
  return (
    <section id="guides" className="py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
          ...
          {content.guides.map((g, i) => {
            ...
            return (
              <a
                ...
                target="_blank"
                rel="noopener"
                className="group relative flex flex-col rounded-2xl border border-white/10 bg-white/[0.02] p-6 transition-all hover:border-white/20 hover:bg-white/[0.04]"
              >
...
function Steps({ content }) {
  return (
    <section className="py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <h2 className="mb-16 font-serif text-3xl leading-tight text-white md:text-5xl">
          {content.stepsTitle}
        </h2>
          ...
          {content.faq.map((item, i) => (
            ...
            >
              ...
              >
                ...
                <span
                  className={`mt-1 text-2xl leading-none text-zinc-500 transition-transform ${
                    open === i ? "rotate-45" : ""
                  }`}
                >
                  +
    ...
    <section className="py-24 md:py-32">
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          className="group mt-10 inline-flex items-center justify-center gap-2 rounded-full bg-white px-8 py-4 text-base font-medium text-zinc-900 transition-all hover:bg-zinc-200"
        >
          {content.ctaBtn}
          <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
        </a>
    ...
    <footer className="border-t border-white/5 bg-zinc-950 pt-20 pb-12">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div>
            <h4 className="mb-4 text-xs font-medium uppercase tracking-[0.2em] text-zinc-500">
        ...
        <div className="mt-16 border-t border-white/5 pt-8 text-xs text-zinc-600">
...
export default function SkyFortLanding() {
  ...
  // On mount: load saved lang or detect from browser
  useEffect(() => {
