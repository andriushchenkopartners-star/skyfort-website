...
// HERO — split layout: text left, portrait right (photo on top on mobile)
        ...
        <div className="order-first lg:order-last">
          <div className="relative mx-auto w-full max-w-[360px] lg:max-w-none">
            ...
            <img
              ...
              className="relative w-full rounded-[24px] border border-[#2a2a2a] object-cover shadow-2xl"
        ...
        <div className="overflow-hidden rounded-3xl border border-[#FFB627]/30 bg-gradient-to-br from-[#1f1f1f] to-[#2d2418] p-10 md:p-14">
          <div className="grid items-center gap-8 md:grid-cols-[1.5fr_1fr]">
            <div>
              ...
              <Link
                href="/calculators/financial-freedom"
...
export default function SkyFortLanding() {
  ...
  return (
    <main className="min-h-screen bg-[#191919] text-white antialiased">
      ...
      <FireCalcPromo lang={lang} />
      <MortgagePromo lang={lang} />
